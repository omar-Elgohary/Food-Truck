...
<div id="sidebar-menu">
    ...
    <ul class="metismenu list-unstyled" id="side-menu">
        ...
        <li>
            <a href="javascript: void(0);" class="has-arrow"><i class="fa fa-solid fa-users"></i>
                <span>المستخدمين</span></a>
            <ul class="sub-menu" aria-expanded="true">
                <li><a href="layouts-dark-sidebar.html">البائعون</a></li>
                <li><a href="layouts-dark-sidebar.html">العملاء</a></li>
            </ul>
        </li>
